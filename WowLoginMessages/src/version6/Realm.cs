...
public class Realm {
    public required Version6.RealmType RealmType { get; set; }
    public required bool Locked { get; set; }
    public required Version6.RealmFlag Flag { get; set; }
    public required string Name { get; set; }
    public required string Address { get; set; }
    public required Population Population { get; set; }
    public required byte NumberOfCharactersOnRealm { get; set; }
    public required Version6.RealmCategory Category { get; set; }
    ...
    public static async Task<Realm> ReadAsync(Stream r, CancellationToken cancellationToken = default) {
        var realmType = (Version6.RealmType)await r.ReadByte(cancellationToken).ConfigureAwait(false);
        ...
        var category = (Version6.RealmCategory)await r.ReadByte(cancellationToken).ConfigureAwait(false);
