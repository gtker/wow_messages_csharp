...
public interface Version6ServerMessage {}

public static class ServerOpcodeReader {
    public static async Task<Version6ServerMessage> ReadAsync(Stream r, CancellationToken cancellationToken = default) {
    ...
    /// </summary>
    public static async Task<T?> ExpectOpcode<T>(Stream r, CancellationToken cancellationToken = default) where T: class, Version6ServerMessage {
