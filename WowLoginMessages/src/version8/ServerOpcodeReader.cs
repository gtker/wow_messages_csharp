...
public interface Version8ServerMessage {}

public static class ServerOpcodeReader {
    public static async Task<Version8ServerMessage> ReadAsync(Stream r, CancellationToken cancellationToken = default) {
    ...
    /// </summary>
    public static async Task<T?> ExpectOpcode<T>(Stream r, CancellationToken cancellationToken = default) where T: class, Version8ServerMessage {
