...
public class CMD_REALM_LIST_Server: Version8ServerMessage, ILoginMessage {
    ...
    public static async Task<CMD_REALM_LIST_Server> ReadAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        for (var i = 0; i < numberOfRealms; ++i) {
            realms.Add(await Version8.Realm.ReadAsync(r, cancellationToken).ConfigureAwait(false));
        }
