...
public class CMD_AUTH_LOGON_PROOF_Client: Version7ClientMessage, ILoginMessage {
    ...
    public static async Task<CMD_AUTH_LOGON_PROOF_Client> ReadAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        for (var i = 0; i < numberOfTelemetryKeys; ++i) {
            telemetryKeys.Add(await Version7.TelemetryKey.ReadAsync(r, cancellationToken).ConfigureAwait(false));
        }
