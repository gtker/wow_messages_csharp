...
public class Realm {
    public required Version5.RealmType RealmType { get; set; }
    public required bool Locked { get; set; }
    public required Version5.RealmFlag Flag { get; set; }
    public required string Name { get; set; }
    public required string Address { get; set; }
    public required Population Population { get; set; }
    public required byte NumberOfCharactersOnRealm { get; set; }
    public required Version5.RealmCategory Category { get; set; }
    ...
    public static async Task<Realm> ReadAsync(Stream r, CancellationToken cancellationToken = default) {
        var realmType = (Version5.RealmType)await r.ReadByte(cancellationToken).ConfigureAwait(false);
        ...
        var category = (Version5.RealmCategory)await r.ReadByte(cancellationToken).ConfigureAwait(false);
