...
jtd-codegen --csharp-system-text-out ${GENERATOR_DIR}/src/generated --csharp-system-text-namespace 'Gtker.WowMessages.Generator.Generated' ${GENERATOR_DIR}/wow_messages/intermediate_representation_schema.json
