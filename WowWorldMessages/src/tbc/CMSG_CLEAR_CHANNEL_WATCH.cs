...
public class CMSG_CLEAR_CHANNEL_WATCH: TbcClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, (uint)Size() + 4, 1010, cancellationToken).ConfigureAwait(false);
