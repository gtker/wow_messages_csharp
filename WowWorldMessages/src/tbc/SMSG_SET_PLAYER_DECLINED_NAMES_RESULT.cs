...
public class SMSG_SET_PLAYER_DECLINED_NAMES_RESULT: TbcServerMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, 14, 1049, cancellationToken).ConfigureAwait(false);
