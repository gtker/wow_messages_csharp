...
public class SMSG_PETITION_QUERY_RESPONSE: TbcServerMessage, IWorldMessage {
    ...
    public required Tbc.CharterType CharterType { get; set; }
    ...
    public static async Task<SMSG_PETITION_QUERY_RESPONSE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var charterType = (Tbc.CharterType)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
