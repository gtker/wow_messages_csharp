...
public class SMSG_QUESTGIVER_STATUS: TbcServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Tbc.QuestGiverStatus Status { get; set; }
    ...
    public static async Task<SMSG_QUESTGIVER_STATUS> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var status = (Tbc.QuestGiverStatus)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
