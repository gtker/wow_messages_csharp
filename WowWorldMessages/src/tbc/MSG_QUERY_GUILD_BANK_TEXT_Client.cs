...
public class MSG_QUERY_GUILD_BANK_TEXT_Client: TbcClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, 5, 1033, cancellationToken).ConfigureAwait(false);
