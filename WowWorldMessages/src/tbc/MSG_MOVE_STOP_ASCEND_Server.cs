...
public class MSG_MOVE_STOP_ASCEND_Server: TbcServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_STOP_ASCEND_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_STOP_ASCEND_Server {
            Guid = guid,
            Info = info,
        };
    }
