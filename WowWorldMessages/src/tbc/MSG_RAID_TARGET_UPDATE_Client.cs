...
public class MSG_RAID_TARGET_UPDATE_Client: TbcClientMessage, IWorldMessage {
    ...
    internal RaidTargetIndex TargetIndexValue => TargetIndex.Match(
        _ => Tbc.RaidTargetIndex.Unknown0,
        _ => Tbc.RaidTargetIndex.Unknown1,
        _ => Tbc.RaidTargetIndex.Unknown2,
        _ => Tbc.RaidTargetIndex.Unknown3,
        _ => Tbc.RaidTargetIndex.Unknown4,
        _ => Tbc.RaidTargetIndex.Unknown5,
        _ => Tbc.RaidTargetIndex.Unknown6,
        _ => Tbc.RaidTargetIndex.Unknown7,
        _ => Tbc.RaidTargetIndex.Unknown8,
        v => v
    );
    ...
    public static async Task<MSG_RAID_TARGET_UPDATE_Client> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        RaidTargetIndexType targetIndex = (Tbc.RaidTargetIndex)await r.ReadByte(cancellationToken).ConfigureAwait(false);

        if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown0) {
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown1) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown2) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown3) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown4) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown5) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown6) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown7) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
        ...
        else if (targetIndex.Value is Tbc.RaidTargetIndex.Unknown8) {
            var target = await r.ReadULong(cancellationToken).ConfigureAwait(false);
