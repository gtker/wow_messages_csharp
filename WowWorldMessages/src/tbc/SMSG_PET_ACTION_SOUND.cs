...
public class SMSG_PET_ACTION_SOUND: TbcServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Tbc.PetTalkReason Reason { get; set; }
    ...
    public static async Task<SMSG_PET_ACTION_SOUND> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var reason = (Tbc.PetTalkReason)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
