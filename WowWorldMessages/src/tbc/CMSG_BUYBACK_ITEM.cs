...
public class CMSG_BUYBACK_ITEM: TbcClientMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Tbc.BuybackSlot Slot { get; set; }
    ...
    public static async Task<CMSG_BUYBACK_ITEM> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var slot = (Tbc.BuybackSlot)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
