...
public static class ServerOpcodeReader {
    ...
    private static async Task<TbcServerMessage> ReadBodyAsync(Stream r, HeaderData header, CancellationToken cancellationToken = default) {
        return header.Opcode switch {
            ...
            857 => await MSG_MOVE_START_ASCEND_Server.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            858 => await MSG_MOVE_STOP_ASCEND_Server.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            935 => await MSG_MOVE_START_DESCEND_Server.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
