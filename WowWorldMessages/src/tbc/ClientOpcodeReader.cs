...
public interface TbcClientMessage {}

public static class ClientOpcodeReader {
    public static async Task<TbcClientMessage> ReadEncryptedAsync(Stream r, TbcDecryption decrypter, CancellationToken cancellationToken = default) {
    ...
    public static async Task<TbcClientMessage> ReadUnencryptedAsync(Stream r, CancellationToken cancellationToken = default) {
    ...
    private static async Task<TbcClientMessage> ReadBodyAsync(Stream r, HeaderData header, CancellationToken cancellationToken = default) {
        return header.Opcode switch {
            ...
            512 => await CMSG_SET_LOOKING_FOR_GROUP.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            857 => await MSG_MOVE_START_ASCEND_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            858 => await MSG_MOVE_STOP_ASCEND_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            860 => await CMSG_LFG_SET_AUTOJOIN.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            861 => await CMSG_LFG_CLEAR_AUTOJOIN.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            862 => await CMSG_LFM_SET_AUTOFILL.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            863 => await CMSG_LFM_CLEAR_AUTOFILL.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            867 => await CMSG_CLEAR_LOOKING_FOR_GROUP.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            868 => await CMSG_CLEAR_LOOKING_FOR_MORE.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            869 => await CMSG_SET_LOOKING_FOR_MORE.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            935 => await MSG_MOVE_START_DESCEND_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            948 => await CMSG_COMMENTATOR_ENABLE.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            965 => await MSG_RAID_READY_CHECK_FINISHED_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            966 => await CMSG_COMPLAIN.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            977 => await CMSG_CHANNEL_DISPLAY_LIST.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            978 => await CMSG_SET_ACTIVE_VOICE_CHANNEL.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            979 => await CMSG_GET_CHANNEL_MEMBER_COUNT.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            981 => await CMSG_CHANNEL_VOICE_ON.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            995 => await CMSG_REPORT_PVP_AFK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            997 => await CMSG_GUILD_BANKER_ACTIVATE.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            998 => await CMSG_GUILD_BANK_QUERY_TAB.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1000 => await CMSG_GUILD_BANK_SWAP_ITEMS.ReadBodyAsync(r, header.Size, cancellationToken).ConfigureAwait(false),
            1001 => await CMSG_GUILD_BANK_BUY_TAB.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1002 => await CMSG_GUILD_BANK_UPDATE_TAB.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1003 => await CMSG_GUILD_BANK_DEPOSIT_MONEY.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1004 => await CMSG_GUILD_BANK_WITHDRAW_MONEY.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1005 => await MSG_GUILD_BANK_LOG_QUERY_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1006 => await CMSG_SET_CHANNEL_WATCH.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1010 => await CMSG_CLEAR_CHANNEL_WATCH.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1015 => await CMSG_SPELLCLICK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1020 => await MSG_GUILD_PERMISSIONS_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1021 => await MSG_GUILD_BANK_MONEY_WITHDRAWN_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1022 => await MSG_GUILD_EVENT_LOG_QUERY_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1024 => await CMSG_GET_MIRRORIMAGE_DATA.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1030 => await CMSG_KEEP_ALIVE.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1032 => await CMSG_OPT_OUT_OF_LOOT.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1033 => await MSG_QUERY_GUILD_BANK_TEXT_Client.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1034 => await CMSG_SET_GUILD_BANK_TEXT.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1036 => await CMSG_GRANT_LEVEL.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1043 => await CMSG_TOTEM_DESTROYED.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1046 => await CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1048 => await CMSG_SET_PLAYER_DECLINED_NAMES.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1055 => await CMSG_ACCEPT_LEVEL_GRANT.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
    ...
    /// </summary>
    public static async Task<T?> ExpectEncryptedOpcode<T>(Stream r, TbcDecryption decrypter, CancellationToken cancellationToken = default) where T: class, TbcClientMessage {
    ...
    /// Expects an opcode to be the next sent. Returns null if type is not correct.
    /// </summary>
    public static async Task<T?> ExpectUnencryptedOpcode<T>(Stream r, CancellationToken cancellationToken = default) where T: class, TbcClientMessage {
