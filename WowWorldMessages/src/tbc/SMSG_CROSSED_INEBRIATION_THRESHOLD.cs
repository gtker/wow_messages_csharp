...
public class SMSG_CROSSED_INEBRIATION_THRESHOLD: TbcServerMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, 18, 960, cancellationToken).ConfigureAwait(false);
