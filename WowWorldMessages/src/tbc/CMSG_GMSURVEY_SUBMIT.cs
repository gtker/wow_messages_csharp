...
public class CMSG_GMSURVEY_SUBMIT: TbcClientMessage, IWorldMessage {
    /// <summary>
    ...
    public static async Task<CMSG_GMSURVEY_SUBMIT> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        for (var i = 0; i < QuestionsLength; ++i) {
            questions[i] = await Tbc.GmSurveyQuestion.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false);
        }
