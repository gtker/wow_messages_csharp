...
public class CMSG_GET_MIRRORIMAGE_DATA: TbcClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, 12, 1024, cancellationToken).ConfigureAwait(false);
