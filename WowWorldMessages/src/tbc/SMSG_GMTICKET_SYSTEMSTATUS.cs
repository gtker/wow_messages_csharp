...
public class SMSG_GMTICKET_SYSTEMSTATUS: TbcServerMessage, IWorldMessage {
    /// <summary>
    ...
    /// </summary>
    public required Tbc.GmTicketQueueStatus WillAcceptTickets { get; set; }
    ...
    public static async Task<SMSG_GMTICKET_SYSTEMSTATUS> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        var willAcceptTickets = (Tbc.GmTicketQueueStatus)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
