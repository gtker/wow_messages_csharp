...
public class CMSG_GUILD_BANK_BUY_TAB: TbcClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, 13, 1001, cancellationToken).ConfigureAwait(false);
