...
public class SMSG_AUCTION_BIDDER_LIST_RESULT: TbcServerMessage, IWorldMessage {
    ...
    public static async Task<SMSG_AUCTION_BIDDER_LIST_RESULT> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        for (var i = 0; i < count; ++i) {
            auctions.Add(await Tbc.AuctionListItem.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false));
        }
