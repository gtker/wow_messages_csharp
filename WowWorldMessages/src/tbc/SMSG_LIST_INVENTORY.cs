...
public class SMSG_LIST_INVENTORY: TbcServerMessage, IWorldMessage {
    ...
    public static async Task<SMSG_LIST_INVENTORY> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        for (var i = 0; i < amountOfItems; ++i) {
            items.Add(await Tbc.ListInventoryItem.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false));
        }
