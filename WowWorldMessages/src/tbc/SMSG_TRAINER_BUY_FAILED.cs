...
public class SMSG_TRAINER_BUY_FAILED: TbcServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required uint Id { get; set; }
    public required Tbc.TrainingFailureReason Error { get; set; }
    ...
    public static async Task<SMSG_TRAINER_BUY_FAILED> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var error = (Tbc.TrainingFailureReason)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
