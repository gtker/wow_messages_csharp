...
public class QuestGiverStatusReport {
    ...
    public required Tbc.QuestGiverStatus DialogStatus { get; set; }
    ...
    public static async Task<QuestGiverStatusReport> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var dialogStatus = (Tbc.QuestGiverStatus)await r.ReadByte(cancellationToken).ConfigureAwait(false);
