...
public class CMSG_GUILD_BANK_UPDATE_TAB: TbcClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, (uint)Size() + 4, 1002, cancellationToken).ConfigureAwait(false);
