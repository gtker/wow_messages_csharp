...
public class ItemSpells {
    ...
    public required Tbc.SpellTriggerType SpellTrigger { get; set; }
    /// <summary>
    ...
    public static async Task<ItemSpells> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var spellTrigger = (Tbc.SpellTriggerType)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
