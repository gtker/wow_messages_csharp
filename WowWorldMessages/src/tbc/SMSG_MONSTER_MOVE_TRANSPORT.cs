...
public class SMSG_MONSTER_MOVE_TRANSPORT: TbcServerMessage, IWorldMessage {
    ...
    internal MonsterMoveType MoveTypeValue => MoveType.Match(
        _ => Tbc.MonsterMoveType.FacingAngle,
        _ => Tbc.MonsterMoveType.FacingSpot,
        _ => Tbc.MonsterMoveType.FacingTarget,
        v => v
    );
    public required Tbc.SplineFlag SplineFlags { get; set; }
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        await ReadUtils.TbcWriteMonsterMoveSpline(w, Splines, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_MONSTER_MOVE_TRANSPORT> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        MonsterMoveTypeType moveType = (Tbc.MonsterMoveType)await r.ReadByte(cancellationToken).ConfigureAwait(false);

        if (moveType.Value is Tbc.MonsterMoveType.FacingTarget) {
        ...
        else if (moveType.Value is Tbc.MonsterMoveType.FacingAngle) {
        ...
        else if (moveType.Value is Tbc.MonsterMoveType.FacingSpot) {
        ...
        var splines = await ReadUtils.TbcReadMonsterMoveSpline(r, cancellationToken).ConfigureAwait(false);
    ...
    internal int Size() {
        ...
        size += ReadUtils.TbcMonsterMoveSplineLength(Splines);
