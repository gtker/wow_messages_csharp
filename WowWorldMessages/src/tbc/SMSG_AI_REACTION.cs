...
public class SMSG_AI_REACTION: TbcServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Tbc.AiReaction Reaction { get; set; }
    ...
    public static async Task<SMSG_AI_REACTION> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var reaction = (Tbc.AiReaction)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
