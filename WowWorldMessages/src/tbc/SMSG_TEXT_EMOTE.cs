...
public class SMSG_TEXT_EMOTE: TbcServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Tbc.TextEmote TextEmote { get; set; }
    ...
    public static async Task<SMSG_TEXT_EMOTE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var textEmote = (Tbc.TextEmote)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
