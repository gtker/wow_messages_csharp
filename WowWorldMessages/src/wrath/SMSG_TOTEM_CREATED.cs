...
public class SMSG_TOTEM_CREATED: WrathServerMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, 19, 1043, cancellationToken).ConfigureAwait(false);
