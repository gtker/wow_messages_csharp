...
using WorldResultType = OneOf.OneOf<SMSG_CHAR_CUSTOMIZE.WorldResultResponseSuccess, WorldResult>;

[System.CodeDom.Compiler.GeneratedCode("WoWM", "0.1.0")]
// ReSharper disable once InconsistentNaming
public class SMSG_CHAR_CUSTOMIZE: WrathServerMessage, IWorldMessage {
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        if (Result.Value is SMSG_CHAR_CUSTOMIZE.WorldResultResponseSuccess worldResultResponseSuccess) {
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, (uint)Size() + 2, 1140, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_CHAR_CUSTOMIZE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new SMSG_CHAR_CUSTOMIZE {
            Result = result,
        };
    }
