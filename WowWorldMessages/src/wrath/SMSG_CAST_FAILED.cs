...
using SpellCastResultType = OneOf.OneOf<SMSG_CAST_FAILED.SpellCastResultCustomError, SMSG_CAST_FAILED.SpellCastResultEquippedItemClass, SMSG_CAST_FAILED.SpellCastResultEquippedItemClassMainhand, SMSG_CAST_FAILED.SpellCastResultEquippedItemClassOffhand, SMSG_CAST_FAILED.SpellCastResultFishingTooLow, SMSG_CAST_FAILED.SpellCastResultMinSkill, SMSG_CAST_FAILED.SpellCastResultNeedExoticAmmo, SMSG_CAST_FAILED.SpellCastResultNeedMoreItems, SMSG_CAST_FAILED.SpellCastResultPreventedByMechanic, SMSG_CAST_FAILED.SpellCastResultReagents, SMSG_CAST_FAILED.SpellCastResultRequiresArea, SMSG_CAST_FAILED.SpellCastResultRequiresSpellFocus, SMSG_CAST_FAILED.SpellCastResultTooManyOfItem, SMSG_CAST_FAILED.SpellCastResultTotems, SMSG_CAST_FAILED.SpellCastResultTotemCategory, SpellCastResult>;

[System.CodeDom.Compiler.GeneratedCode("WoWM", "0.1.0")]
// ReSharper disable once InconsistentNaming
public class SMSG_CAST_FAILED: WrathServerMessage, IWorldMessage {
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        if (Result.Value is SMSG_CAST_FAILED.SpellCastResultRequiresSpellFocus spellCastResultRequiresSpellFocus) {
            await w.WriteUInt(spellCastResultRequiresSpellFocus.SpellFocus, cancellationToken).ConfigureAwait(false);

        }
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultRequiresArea spellCastResultRequiresArea) {
        ...
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultEquippedItemClassOffhand spellCastResultEquippedItemClassOffhand) {
        ...
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultEquippedItemClassMainhand spellCastResultEquippedItemClassMainhand) {
        ...
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultTooManyOfItem spellCastResultTooManyOfItem) {
            await w.WriteUInt(spellCastResultTooManyOfItem.ItemLimitCategory, cancellationToken).ConfigureAwait(false);

        }
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultCustomError spellCastResultCustomError) {
            await w.WriteUInt(spellCastResultCustomError.CustomError, cancellationToken).ConfigureAwait(false);

        }
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultReagents spellCastResultReagents) {
            await w.WriteUInt(spellCastResultReagents.MissingItem, cancellationToken).ConfigureAwait(false);

        }
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultPreventedByMechanic spellCastResultPreventedByMechanic) {
            await w.WriteUInt(spellCastResultPreventedByMechanic.Mechanic, cancellationToken).ConfigureAwait(false);

        }
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultNeedExoticAmmo spellCastResultNeedExoticAmmo) {
            await w.WriteUInt(spellCastResultNeedExoticAmmo.EquippedItemSubClass, cancellationToken).ConfigureAwait(false);

        }
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultNeedMoreItems spellCastResultNeedMoreItems) {
        ...
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultMinSkill spellCastResultMinSkill) {
        ...
        else if (Result.Value is SMSG_CAST_FAILED.SpellCastResultFishingTooLow spellCastResultFishingTooLow) {
    ...
    public static async Task<SMSG_CAST_FAILED> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
