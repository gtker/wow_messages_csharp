...
public class ListInventoryItem {
    ...
    public required uint ExtendedCost { get; set; }
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        await w.WriteUInt(ExtendedCost, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<ListInventoryItem> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var extendedCost = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
