...
public class ItemSpells {
    ...
    public required Wrath.SpellTriggerType SpellTrigger { get; set; }
    /// <summary>
    ...
    public static async Task<ItemSpells> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var spellTrigger = (Wrath.SpellTriggerType)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
