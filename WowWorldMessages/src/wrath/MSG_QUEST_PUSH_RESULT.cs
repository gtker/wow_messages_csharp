...
public class MSG_QUEST_PUSH_RESULT: WrathClientMessage, WrathServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Wrath.QuestPartyMessage Message { get; set; }
    ...
    public static async Task<MSG_QUEST_PUSH_RESULT> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var message = (Wrath.QuestPartyMessage)await r.ReadByte(cancellationToken).ConfigureAwait(false);
