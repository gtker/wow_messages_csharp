...
public class SMSG_QUESTGIVER_REQUEST_ITEMS: WrathServerMessage, IWorldMessage {
    ...
    public required Wrath.QuestCompletable Completable { get; set; }
    /// <summary>
    ...
    /// </summary>
    public required uint Flags4 { get; set; }
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        await w.WriteUInt(Flags4, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_QUESTGIVER_REQUEST_ITEMS> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        for (var i = 0; i < amountOfRequiredItems; ++i) {
            requiredItems.Add(await Wrath.QuestItemRequirement.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false));
        }

        var completable = (Wrath.QuestCompletable)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
        ...
        var flags4 = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
    ...
    internal int Size() {
        ...
        // flags4: Generator.Generated.DataTypeInteger
        size += 4;
