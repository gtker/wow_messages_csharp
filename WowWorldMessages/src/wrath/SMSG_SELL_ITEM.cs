...
public class SMSG_SELL_ITEM: WrathServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required ulong Item { get; set; }
    public required Wrath.SellItemResult Result { get; set; }
    ...
    public static async Task<SMSG_SELL_ITEM> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var result = (Wrath.SellItemResult)await r.ReadByte(cancellationToken).ConfigureAwait(false);
