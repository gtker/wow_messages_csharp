...
public static class ClientOpcodeReader {
    ...
    private static async Task<WrathClientMessage> ReadBodyAsync(Stream r, HeaderData header, CancellationToken cancellationToken = default) {
        return header.Opcode switch {
            ...
            197 => await MSG_MOVE_TELEPORT_Server.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            832 => await CMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY_ACK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            837 => await CMSG_MOVE_SET_CAN_FLY_ACK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            838 => await CMSG_MOVE_SET_FLY.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            898 => await CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            900 => await CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            909 => await CMSG_MOVE_CHNG_TRANSPORT.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            1179 => await CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            1231 => await CMSG_MOVE_GRAVITY_DISABLE_ACK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            1233 => await CMSG_MOVE_GRAVITY_ENABLE_ACK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
            ...
            1303 => await CMSG_MOVE_SET_COLLISION_HGT_ACK.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false),
