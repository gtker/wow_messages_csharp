...
public class CMSG_CALENDAR_REMOVE_EVENT: WrathClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, 24, 1071, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<CMSG_CALENDAR_REMOVE_EVENT> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new CMSG_CALENDAR_REMOVE_EVENT {
