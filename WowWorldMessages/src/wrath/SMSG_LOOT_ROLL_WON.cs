...
public class SMSG_LOOT_ROLL_WON: WrathServerMessage, IWorldMessage {
    ...
    /// </summary>
    public required Wrath.RollVote Vote { get; set; }
    ...
    public static async Task<SMSG_LOOT_ROLL_WON> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var vote = (Wrath.RollVote)await r.ReadByte(cancellationToken).ConfigureAwait(false);
