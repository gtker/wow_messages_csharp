...
public class MSG_MOVE_START_PITCH_UP: WrathClientMessage, WrathServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_START_PITCH_UP> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_START_PITCH_UP {
            Guid = guid,
            Info = info,
        };
    }
