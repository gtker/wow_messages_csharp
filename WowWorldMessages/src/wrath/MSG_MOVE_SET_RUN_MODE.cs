...
public class MSG_MOVE_SET_RUN_MODE: WrathClientMessage, WrathServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_SET_RUN_MODE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_SET_RUN_MODE {
            Guid = guid,
            Info = info,
        };
    }
