...
public class SMSG_TRAINER_BUY_FAILED: WrathServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required uint Id { get; set; }
    public required Wrath.TrainingFailureReason Error { get; set; }
    ...
    public static async Task<SMSG_TRAINER_BUY_FAILED> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var error = (Wrath.TrainingFailureReason)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
