...
public class SMSG_LEVELUP_INFO: WrathServerMessage, IWorldMessage {
    ...
    public required uint RunicPower { get; set; }
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        await w.WriteUInt(RunicPower, cancellationToken).ConfigureAwait(false);
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, 58, 468, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_LEVELUP_INFO> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var runicPower = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
