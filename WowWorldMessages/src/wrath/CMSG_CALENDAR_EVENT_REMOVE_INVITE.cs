...
public class CMSG_CALENDAR_EVENT_REMOVE_INVITE: WrathClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, 28, 1075, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<CMSG_CALENDAR_EVENT_REMOVE_INVITE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new CMSG_CALENDAR_EVENT_REMOVE_INVITE {
