...
public class SpellLog {
    ...
    public class SpellEffectCreateItem2 {
        public required uint Item { get; set; }
    }
    ...
    public class SpellEffectResurrect {
        public required ulong ResurrectGuid { get; set; }
    }
    public class SpellEffectResurrectNew {
        public required ulong ResurrectGuid { get; set; }
    }
    ...
    internal SpellEffect EffectValue => Effect.Match(
        _ => Wrath.SpellEffect.AddExtraAttacks,
        _ => Wrath.SpellEffect.CreateHouse,
        _ => Wrath.SpellEffect.CreateItem,
        _ => Wrath.SpellEffect.CreateItem2,
        _ => Wrath.SpellEffect.DismissPet,
        _ => Wrath.SpellEffect.Duel,
        _ => Wrath.SpellEffect.DurabilityDamage,
        _ => Wrath.SpellEffect.FeedPet,
        _ => Wrath.SpellEffect.InterruptCast,
        _ => Wrath.SpellEffect.OpenLock,
        _ => Wrath.SpellEffect.OpenLockItem,
        _ => Wrath.SpellEffect.PowerDrain,
        _ => Wrath.SpellEffect.Resurrect,
        _ => Wrath.SpellEffect.ResurrectNew,
        _ => Wrath.SpellEffect.Summon,
        _ => Wrath.SpellEffect.SummonObjectSlot1,
        _ => Wrath.SpellEffect.SummonObjectSlot2,
        _ => Wrath.SpellEffect.SummonObjectSlot3,
        _ => Wrath.SpellEffect.SummonObjectSlot4,
        _ => Wrath.SpellEffect.SummonObjectWild,
        _ => Wrath.SpellEffect.SummonPet,
        _ => Wrath.SpellEffect.TransDoor,
        v => v
    );
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        else if (Effect.Value is SpellLog.SpellEffectCreateItem2 spellEffectCreateItem2) {
            await w.WriteUInt(spellEffectCreateItem2.Item, cancellationToken).ConfigureAwait(false);
        ...
        else if (Effect.Value is SpellLog.SpellEffectResurrect spellEffectResurrect) {
            await w.WritePackedGuid(spellEffectResurrect.ResurrectGuid, cancellationToken).ConfigureAwait(false);

        }
        else if (Effect.Value is SpellLog.SpellEffectResurrectNew spellEffectResurrectNew) {
            await w.WritePackedGuid(spellEffectResurrectNew.ResurrectGuid, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SpellLog> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        SpellEffectType effect = (Wrath.SpellEffect)await r.ReadUInt(cancellationToken).ConfigureAwait(false);

        // ReSharper disable once UnusedVariable.Compiler
        var amountOfLogs = await r.ReadUInt(cancellationToken).ConfigureAwait(false);

        if (effect.Value is Wrath.SpellEffect.PowerDrain) {
        ...
        else if (effect.Value is Wrath.SpellEffect.AddExtraAttacks) {
        ...
        else if (effect.Value is Wrath.SpellEffect.InterruptCast) {
        ...
        else if (effect.Value is Wrath.SpellEffect.DurabilityDamage) {
        ...
        else if (effect.Value is Wrath.SpellEffect.OpenLock) {
        ...
        else if (effect.Value is Wrath.SpellEffect.OpenLockItem) {
            var lockTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.CreateItem) {
        ...
        else if (effect.Value is Wrath.SpellEffect.CreateItem2) {
            var item = await r.ReadUInt(cancellationToken).ConfigureAwait(false);

            effect = new SpellEffectCreateItem2 {
                Item = item,
            };
        }

        else if (effect.Value is Wrath.SpellEffect.Summon) {
        ...
        else if (effect.Value is Wrath.SpellEffect.TransDoor) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.SummonPet) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.SummonObjectWild) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.CreateHouse) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.Duel) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.SummonObjectSlot1) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.SummonObjectSlot2) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.SummonObjectSlot3) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.SummonObjectSlot4) {
            var summonTarget = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);
        ...
        else if (effect.Value is Wrath.SpellEffect.FeedPet) {
        ...
        else if (effect.Value is Wrath.SpellEffect.DismissPet) {
        ...
        else if (effect.Value is Wrath.SpellEffect.Resurrect) {
            var resurrectGuid = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);

            effect = new SpellEffectResurrect {
                ResurrectGuid = resurrectGuid,
            };
        }
        else if (effect.Value is Wrath.SpellEffect.ResurrectNew) {
            var resurrectGuid = await r.ReadPackedGuid(cancellationToken).ConfigureAwait(false);

            effect = new SpellEffectResurrectNew {
                ResurrectGuid = resurrectGuid,
            };
        }
    ...
    internal int Size() {
        ...
        if (Effect.Value is SpellLog.SpellEffectPowerDrain spellEffectPowerDrain) {
            ...
            // resurrect_guid: Generator.Generated.DataTypePackedGuid
            size += spellEffectResurrect.ResurrectGuid.PackedGuidLength();

        }
        else if (Effect.Value is SpellLog.SpellEffectResurrectNew spellEffectResurrectNew) {
            // resurrect_guid: Generator.Generated.DataTypePackedGuid
            size += spellEffectResurrectNew.ResurrectGuid.PackedGuidLength();
