...
public class CMSG_CHAR_RACE_CHANGE: WrathClientMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedClientAsync(Stream w, IClientEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteClientHeaderAsync(w, (uint)Size() + 4, 1272, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<CMSG_CHAR_RACE_CHANGE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new CMSG_CHAR_RACE_CHANGE {
            Player = player,
            Name = name,
            Gender = gender,
            SkinColor = skinColor,
