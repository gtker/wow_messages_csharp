...
public class SMSG_CALENDAR_FILTER_GUILD: WrathServerMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, (uint)Size() + 2, 1080, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_CALENDAR_FILTER_GUILD> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new SMSG_CALENDAR_FILTER_GUILD {
            Members = members,
        };
    }
