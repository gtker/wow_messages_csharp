...
public class SMSG_ITEM_QUERY_SINGLE_RESPONSE: WrathServerMessage, IWorldMessage {
    public required uint Item { get; set; }
    public struct OptionalFound {
        public required Wrath.ItemClassAndSubClass ClassAndSubClass { get; set; }
        /// <summary>
        ...
        /// </summary>
        public required uint SoundOverrideSubClass { get; set; }
        ...
        public required Wrath.ItemQuality Quality { get; set; }
        public required Wrath.ItemFlag Flags { get; set; }
        public required Wrath.ItemFlag2 Flags2 { get; set; }
        ...
        public required Wrath.AllowedClass AllowedClass { get; set; }
        public required Wrath.AllowedRace AllowedRace { get; set; }
        public required uint ItemLevel { get; set; }
        public required uint RequiredLevel { get; set; }
        public required Wrath.Skill RequiredSkill { get; set; }
        ...
        public required Wrath.Faction RequiredFaction { get; set; }
        /// <summary>
        ...
        public required List<ItemStat> Stats { get; set; }
        public required uint ScalingStatsEntry { get; set; }
        public required uint ScalingStatsFlag { get; set; }
        public const int DamagesLength = 2;
        ...
        public required Wrath.Bonding Bonding { get; set; }
        public required string Description { get; set; }
        public required uint PageText { get; set; }
        public required Wrath.Language Language { get; set; }
        public required Wrath.PageTextMaterial PageTextMaterial { get; set; }
        /// <summary>
        ...
        public required Wrath.SheatheType SheatheType { get; set; }
        /// <summary>
        /// cmangos/vmangos/mangoszero: id from ItemRandomProperties.dbc
        /// </summary>
        public required uint RandomProperty { get; set; }
        public required uint RandomSuffix { get; set; }
        public required uint Block { get; set; }
        public required Wrath.ItemSet ItemSet { get; set; }
        public required uint MaxDurability { get; set; }
        public required Wrath.Area Area { get; set; }
        public required Wrath.Map Map { get; set; }
        public required Wrath.BagFamily BagFamily { get; set; }
        /// <summary>
        /// mangosone: id from TotemCategory.dbc
        /// </summary>
        public required uint TotemCategory { get; set; }
        public const int SocketsLength = 3;
        public required ItemSocket[] Sockets { get; set; }
        public required uint SocketBonus { get; set; }
        public required uint GemProperties { get; set; }
        public required uint RequiredDisenchantSkill { get; set; }
        public required float ArmorDamageModifier { get; set; }
        /// <summary>
    ...
    public async Task WriteBodyAsync(Stream w, CancellationToken cancellationToken = default) {
        ...
        if (Found is { } found) {
            ...
            await w.WriteUInt(found.SoundOverrideSubClass, cancellationToken).ConfigureAwait(false);
            ...
            await w.WriteUInt((uint)found.Flags2, cancellationToken).ConfigureAwait(false);
            ...
            await w.WriteUInt((uint)found.Stats.Count, cancellationToken).ConfigureAwait(false);

            foreach (var v in found.Stats) {
                await v.WriteBodyAsync(w, cancellationToken).ConfigureAwait(false);
            }

            await w.WriteUInt(found.ScalingStatsEntry, cancellationToken).ConfigureAwait(false);

            await w.WriteUInt(found.ScalingStatsFlag, cancellationToken).ConfigureAwait(false);
            ...
            await w.WriteUInt(found.RandomSuffix, cancellationToken).ConfigureAwait(false);
            ...
            await w.WriteUInt(found.TotemCategory, cancellationToken).ConfigureAwait(false);

            foreach (var v in found.Sockets) {
                await v.WriteBodyAsync(w, cancellationToken).ConfigureAwait(false);
            }

            await w.WriteUInt(found.SocketBonus, cancellationToken).ConfigureAwait(false);

            await w.WriteUInt(found.GemProperties, cancellationToken).ConfigureAwait(false);

            await w.WriteUInt(found.RequiredDisenchantSkill, cancellationToken).ConfigureAwait(false);

            await w.WriteFloat(found.ArmorDamageModifier, cancellationToken).ConfigureAwait(false);

            await w.WriteUInt(found.Duration, cancellationToken).ConfigureAwait(false);

            await w.WriteUInt(found.ItemLimitCategory, cancellationToken).ConfigureAwait(false);

            await w.WriteUInt(found.HolidayId, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_ITEM_QUERY_SINGLE_RESPONSE> ReadBodyAsync(Stream r, uint bodySize, CancellationToken cancellationToken = default) {
        ...
        if (__size < bodySize) {
            var classAndSubClass = (Wrath.ItemClassAndSubClass)await r.ReadULong(cancellationToken).ConfigureAwait(false);
            __size += 8;

            var soundOverrideSubClass = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var quality = (Wrath.ItemQuality)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var flags = (ItemFlag)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var flags2 = (ItemFlag2)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var inventoryType = (Wrath.InventoryType)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var requiredSkill = (Wrath.Skill)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var requiredFaction = (Wrath.Faction)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var amountOfStats = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var stats = new List<ItemStat>();
            for (var i = 0; i < amountOfStats; ++i) {
                stats.Add(await Wrath.ItemStat.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false));
                __size += 8;
            }

            var scalingStatsEntry = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var scalingStatsFlag = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var damages = new ItemDamageType[OptionalFound.DamagesLength];
            for (var i = 0; i < OptionalFound.DamagesLength; ++i) {
                damages[i] = await Wrath.ItemDamageType.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false);
                __size += 12;
            }
            ...
            for (var i = 0; i < OptionalFound.SpellsLength; ++i) {
                spells[i] = await Wrath.ItemSpells.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false);
                __size += 24;
            }

            var bonding = (Wrath.Bonding)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var pageTextMaterial = (Wrath.PageTextMaterial)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var sheatheType = (Wrath.SheatheType)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var randomProperty = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var randomSuffix = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var block = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var itemSet = (Wrath.ItemSet)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            var totemCategory = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var sockets = new ItemSocket[OptionalFound.SocketsLength];
            for (var i = 0; i < OptionalFound.SocketsLength; ++i) {
                sockets[i] = await Wrath.ItemSocket.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false);
                __size += 8;
            }

            var socketBonus = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var gemProperties = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var requiredDisenchantSkill = await r.ReadUInt(cancellationToken).ConfigureAwait(false);
            __size += 4;

            var armorDamageModifier = await r.ReadFloat(cancellationToken).ConfigureAwait(false);
            __size += 4;
            ...
            optionalFound = new OptionalFound {
                ...
                Stats = stats,
                ScalingStatsEntry = scalingStatsEntry,
                ScalingStatsFlag = scalingStatsFlag,
                Damages = damages,
                Armor = armor,
    ...
    internal int Size() {
        ...
        if (Found is { } found) {
            ...
            // sound_override_sub_class: Generator.Generated.DataTypeInteger
            size += 4;
            ...
            // flags2: Generator.Generated.DataTypeFlag
            size += 4;
            ...
            // item_level: Generator.Generated.DataTypeInteger
            size += 4;
            ...
            // amount_of_stats: Generator.Generated.DataTypeInteger
            size += 4;

            // stats: Generator.Generated.DataTypeArray
            size += found.Stats.Sum(e => 8);

            // scaling_stats_entry: Generator.Generated.DataTypeInteger
            size += 4;

            // scaling_stats_flag: Generator.Generated.DataTypeInteger
            size += 4;
            ...
            // random_suffix: Generator.Generated.DataTypeInteger
            size += 4;
            ...
            // bag_family: Generator.Generated.DataTypeFlag
            size += 4;

            // totem_category: Generator.Generated.DataTypeInteger
            size += 4;

            // sockets: Generator.Generated.DataTypeArray
            size += found.Sockets.Sum(e => 8);

            // socket_bonus: Generator.Generated.DataTypeInteger
            size += 4;

            // gem_properties: Generator.Generated.DataTypeInteger
            size += 4;

            // required_disenchant_skill: Generator.Generated.DataTypeInteger
            size += 4;

            // armor_damage_modifier: Generator.Generated.DataTypeFloatingPoint
            size += 4;

            // duration: Generator.Generated.DataTypeSeconds
            size += 4;
