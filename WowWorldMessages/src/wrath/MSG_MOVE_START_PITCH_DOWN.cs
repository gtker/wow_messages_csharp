...
public class MSG_MOVE_START_PITCH_DOWN: WrathClientMessage, WrathServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_START_PITCH_DOWN> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_START_PITCH_DOWN {
            Guid = guid,
            Info = info,
        };
    }
