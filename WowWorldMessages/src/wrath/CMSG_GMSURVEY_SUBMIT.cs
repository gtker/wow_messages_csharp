...
public class CMSG_GMSURVEY_SUBMIT: WrathClientMessage, IWorldMessage {
    /// <summary>
    ...
    public static async Task<CMSG_GMSURVEY_SUBMIT> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        for (var i = 0; i < QuestionsLength; ++i) {
            questions[i] = await Wrath.GmSurveyQuestion.ReadBodyAsync(r, cancellationToken).ConfigureAwait(false);
        }
