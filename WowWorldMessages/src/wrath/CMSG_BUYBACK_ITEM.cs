...
public class CMSG_BUYBACK_ITEM: WrathClientMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Wrath.BuybackSlot Slot { get; set; }
    ...
    public static async Task<CMSG_BUYBACK_ITEM> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var slot = (Wrath.BuybackSlot)await r.ReadUInt(cancellationToken).ConfigureAwait(false);
