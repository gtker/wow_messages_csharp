...
public class SMSG_ENVIRONMENTAL_DAMAGE_LOG: WrathServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required Wrath.EnvironmentalDamageType DamageType { get; set; }
    ...
    public static async Task<SMSG_ENVIRONMENTAL_DAMAGE_LOG> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var damageType = (Wrath.EnvironmentalDamageType)await r.ReadByte(cancellationToken).ConfigureAwait(false);
