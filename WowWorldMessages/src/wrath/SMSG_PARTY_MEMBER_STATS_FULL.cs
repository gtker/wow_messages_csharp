...
public class SMSG_PARTY_MEMBER_STATS_FULL: WrathServerMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, (uint)Size() + 2, 754, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_PARTY_MEMBER_STATS_FULL> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new SMSG_PARTY_MEMBER_STATS_FULL {
            Guid = guid,
            Mask = mask,
        };
    }
