...
public class SMSG_PROCRESIST: WrathServerMessage, IWorldMessage {
    public required ulong Caster { get; set; }
    public required ulong Target { get; set; }
    public required uint Id { get; set; }
    public required Wrath.LogFormat LogFormat { get; set; }
    ...
    public static async Task<SMSG_PROCRESIST> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var logFormat = (Wrath.LogFormat)await r.ReadByte(cancellationToken).ConfigureAwait(false);
