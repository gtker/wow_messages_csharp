...
public class SMSG_BUY_FAILED: WrathServerMessage, IWorldMessage {
    public required ulong Guid { get; set; }
    public required uint Item { get; set; }
    public required Wrath.BuyResult Result { get; set; }
    ...
    public static async Task<SMSG_BUY_FAILED> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var result = (Wrath.BuyResult)await r.ReadByte(cancellationToken).ConfigureAwait(false);
