...
public class SMSG_ARENA_TEAM_QUERY_RESPONSE: WrathServerMessage, IWorldMessage {
    public required uint ArenaTeam { get; set; }
    public required string TeamName { get; set; }
    public required Wrath.ArenaType TeamType { get; set; }
    ...
    public static async Task<SMSG_ARENA_TEAM_QUERY_RESPONSE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        var teamType = (Wrath.ArenaType)await r.ReadByte(cancellationToken).ConfigureAwait(false);
