...
public class MSG_MOVE_START_STRAFE_RIGHT: WrathClientMessage, WrathServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_START_STRAFE_RIGHT> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_START_STRAFE_RIGHT {
            Guid = guid,
            Info = info,
        };
    }
