...
public class MSG_MOVE_STOP_STRAFE_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_STOP_STRAFE_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_STOP_STRAFE_Server {
            Guid = guid,
            Info = info,
        };
    }
