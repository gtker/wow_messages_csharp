...
public class SMSG_MOVE_UNSET_HOVER: VanillaServerMessage, IWorldMessage {
    ...
    public async Task WriteEncryptedServerAsync(Stream w, IServerEncrypter encrypter, CancellationToken cancellationToken = default) {
        await encrypter.WriteServerHeaderAsync(w, (uint)Size() + 2, 245, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<SMSG_MOVE_UNSET_HOVER> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new SMSG_MOVE_UNSET_HOVER {
            Guid = guid,
            Counter = counter,
        };
    }
