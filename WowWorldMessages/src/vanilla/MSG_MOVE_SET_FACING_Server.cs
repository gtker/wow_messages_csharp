...
public class MSG_MOVE_SET_FACING_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_SET_FACING_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_SET_FACING_Server {
            Guid = guid,
            Info = info,
        };
    }
