...
public class MSG_MOVE_STOP_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_STOP_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_STOP_Server {
            Guid = guid,
            Info = info,
        };
    }
