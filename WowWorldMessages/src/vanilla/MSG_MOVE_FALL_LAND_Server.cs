...
public class MSG_MOVE_FALL_LAND_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_FALL_LAND_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_FALL_LAND_Server {
            Guid = guid,
            Info = info,
        };
    }
