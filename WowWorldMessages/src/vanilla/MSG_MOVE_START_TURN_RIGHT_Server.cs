...
public class MSG_MOVE_START_TURN_RIGHT_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_START_TURN_RIGHT_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_START_TURN_RIGHT_Server {
            Guid = guid,
            Info = info,
        };
    }
