...
public class MSG_MOVE_SET_WALK_MODE_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_SET_WALK_MODE_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_SET_WALK_MODE_Server {
            Guid = guid,
            Info = info,
        };
    }
