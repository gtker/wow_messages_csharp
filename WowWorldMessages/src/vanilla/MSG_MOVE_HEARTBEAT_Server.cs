...
public class MSG_MOVE_HEARTBEAT_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_HEARTBEAT_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_HEARTBEAT_Server {
            Guid = guid,
            Info = info,
        };
    }
