...
public class SMSG_GROUP_INVITE: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<SMSG_GROUP_INVITE> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
