...
public class MSG_MOVE_JUMP_Server: VanillaServerMessage, IWorldMessage {
    ...
    public static async Task<MSG_MOVE_JUMP_Server> ReadBodyAsync(Stream r, CancellationToken cancellationToken = default) {
        ...
        return new MSG_MOVE_JUMP_Server {
            Guid = guid,
            Info = info,
        };
    }
